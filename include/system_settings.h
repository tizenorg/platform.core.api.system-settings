...
typedef enum {
	...
	SYSTEM_SETTINGS_KEY_INCOMING_CALL_RINGTONE_SIM1 = SYSTEM_SETTINGS_KEY_INCOMING_CALL_RINGTONE,
	SYSTEM_SETTINGS_KEY_SOUND_NOTIFICATION_SIM1 = SYSTEM_SETTINGS_KEY_SOUND_NOTIFICATION,

	SYSTEM_SETTINGS_KEY_INCOMING_CALL_RINGTONE_SIM2 = SYSTEM_SETTINGS_KEY_LOCK_STATE + 1,
	SYSTEM_SETTINGS_KEY_SOUND_NOTIFICATION_SIM2 = SYSTEM_SETTINGS_KEY_LOCK_STATE + 2,
