...
{
	SETTING_TRACE_BEGIN;
	return system_setting_vconf_set_changed_cb(VCONFKEY_SETAPPL_CALL_RINGTONE_PATH_STR_SIM2, SYSTEM_SETTINGS_KEY_INCOMING_CALL_RINGTONE_SIM2, 0, user_data);
}
...
{
	SETTING_TRACE_BEGIN;
	return system_setting_vconf_set_changed_cb(VCONFKEY_SETAPPL_NOTI_MSG_RINGTONE_PATH_STR_SIM2, SYSTEM_SETTINGS_KEY_INCOMING_CALL_RINGTONE_SIM2, 0, user_data);
}
